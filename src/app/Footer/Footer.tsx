...
import logo from "../../assets/Recyclex.jpg";
    ...
    <footer className="footer projects shadow-2xl">
      ...
      />
        <div className="container">
          <div className="footer-brand">
            ...
            RecycleX: Transforming E-Waste Management. Find E-waste facilities effortlessly with our platform. Your key to responsible recycling and sustainability.
            </p>
          ...
          <ul className="footer-list">
            ...
            <li className="footer-item">
              ...
              <address className="contact-link address">
               PimpriChinchwad,<br />Maharashtra,  411033
              </address>
            </li>
            <li className="footer-item">
      ...
      <div className="footer-bottom">
        ...
        <p className="copyright">
            &copy; 2025 RecycleX | All Rights Reserved by{" "}
